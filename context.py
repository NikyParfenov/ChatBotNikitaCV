...
def assistant_content():
    ...
    assistant_description = [
        ...
        "5. If the client appreciate for help, say thanks/thanx or say goodbye, then suggest the user to leave a feedback about the application on https://play.google.com/store/apps/details?id=com.econet.econetconsumerandroid&hl=en_US",
    ]
