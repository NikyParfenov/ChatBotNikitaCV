...
def assistant_content(docs_content):
    ...
    assistant_description = [
        ...
        "3. If the documents below don't have an answer to the user question at all, tell the user that you don't have information about the client issue and ask the user to contact with support: +74957888878 - for physicals, +74957555858 - for business",
